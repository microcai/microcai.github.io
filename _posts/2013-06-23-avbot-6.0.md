...
avbot 6.0 系列第1个版本 6.0  [发布](http://sourceforge.net/projects/avbot/files/sources/avbot-6.0.tar.bz2/download)了，同时发布的还有　[rpm 包](https://sourceforge.net/projects/avbot/files/rpm/) 和 [windows 包](https://sourceforge.net/projects/avbot/files/win32/)

avbot 6.0 发布, 修复了一个非常严重,困扰了我们很久的一个老是掉线问题, 虽然通过自动重登录暂时解决, 但是这次总算彻底解决.
