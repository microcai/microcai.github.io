---
layout: post
title: A New Taxonomy of Language
tags: [lang]
---
...
1. The brain judges: The current physical frame cut seems misaligned; it needs adjustment.
2. The brain retrieves context: *ten* is a number, *apples* is a noun.
3. The brain executes reorganization: It takes the *n* back from the next frame and gives it to the previous frame, finally reconstructing *"ten apples"*.
