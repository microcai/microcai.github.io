...
avbot 4.0 系列第四个版本 4.3  [发布](http://sourceforge.net/projects/avbot/files/sources/avbot-4.3.tar.bz2/download)了，同时发布的还有　[rpm 包](https://sourceforge.net/projects/avbot/files/rpm/) 和 [windows 包](https://sourceforge.net/projects/avbot/files/win32/)
